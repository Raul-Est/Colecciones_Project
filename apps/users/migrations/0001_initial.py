    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account_status', models.CharField(choices=[('active', 'Activa'), ('suspended', 'Suspendida'), ('pending', 'Pendiente de verificación'), ('deleted', 'Eliminada')], default='active', max_length=20, verbose_name='estado de cuenta')),
